  ...
  return (
    <section className="about" ref={targetRef}>
      ...
      <div className="about-items">
        ...
        >
          "DESIGN IS THE <span className="quotation-animation">VISIBLE</span>{" "}
          REFLECTION
          <br />
          OF THE <span className="quotation-animation-2">INVISIBLE</span>{" "}
          THINKING."
        </motion.span>
        <motion.div
        ...
        >
          ...
          />
          <motion.div
            className="photo-animation-rectangle"
            initial={{
              width: "100%",
            }}
            animate={{
          ...
          ></motion.div>
          <motion.div
            className="photo-animation-rectangle-2"
            initial={{
              width: "100%",
            }}
            animate={{
          ...
          ></motion.div>
          <motion.div
            className="photo-animation-rectangle-3"
            initial={{
              width: "100%",
            }}
            animate={{
          ...
          ></motion.div>
          <motion.div
            className="photo-animation-rectangle-4"
            initial={{
              width: "100%",
            }}
            animate={{
        ...
        >
          "
          <span className="quotation-animation-3" ref={ref2}>
            CODE{" "}
          </span>
          IS POETRY IN <span className="quotation-animation-4">MOTION</span>."
        </motion.span>
      </div>
      <motion.div className="about-items-text" ref={ref}>
        {phrases.map((phrase, index) => (
          <motion.p
            key={index}
            className={`description-txt ${
              activePhraseIndex >= index ? "active" : ""
            }`}
            initial={{ opacity: 0 }}
            animate={{
              opacity: activePhraseIndex >= index && isInView ? 1 : 0,
              display:
                activePhraseIndex === index && isInView ? "block" : "none",
            }}
